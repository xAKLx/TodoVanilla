...
export const todoList = [
  ...
  },
  {
    ...
    tags: [{ text: 'Inspection', color: '#fa90a8' }],
    closed: false,
  },
  {
  ...
  },
  {
    ...
    tags: [{ text: 'Brochure', color: '#c6e99e' }],
    closed: false,
  },
  {
    description:
      'Collect playment cheque from vendor. Deliver new merchendise to main office and take receipt.',
    lead: 'Seri Anand',
    dateTime: new Date(tomorrow.setHours(16, 15, 0, 0)),
    tags: [{ text: 'Delivery', color: '#b0d3fb' }],
    closed: false,
  },
  {
    description: 'Meet client',
